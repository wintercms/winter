...
return [
    ...
    'field' => [
        ...
        'colors_invalid_input' => 'La valeur de couleur fournie est invalide, veuillez réessayer.',
    ],
    'widget' => [
    ...
    'user' => [
        ...
        'auto_generate_password_comment' => 'Créer automatiquement un mot de passe sécurisé aléatoire. Décochez pour définir un mot de passe manuellement.',
        'delete_confirm' => 'Supprimer cet administrateur ?',
        'return' => 'Retour à la liste des administrateurs',
        'allow' => 'Autoriser',
        'inherit' => 'Hériter',
        'deny' => 'Interdire',
        'permissions_toggle_section_allow' => 'Autoriser toutes les permissions dans cette section',
        'permissions_toggle_section_inherit' => 'Hériter de toutes les permissions dans cette section',
        'permissions_toggle_section_deny' => 'Interdire toutes les permissions dans cette section',
        'activated' => 'Activé',
        ...
        'self_escalation_denied' => 'Vous ne pouvez pas modifier votre propre rôle, vos permissions ou votre statut de super-utilisateur.',
        'cannot_manage_user' => 'Vous n\'avez pas la permission de gérer cet administrateur.',
        'throttle_tab' => 'Échecs de connexion',
        'throttle_tab_label' => 'Historique des échecs de connexion',
        'throttle_comment' => 'Voir les tentatives de connexion échouées pour cet utilisateur. Ces enregistrements sont générés automatiquement lorsque les tentatives de connexion échouent. Les utilisateurs sont suspendus après avoir dépassé la limite de tentatives.',
        'throttle_ip_address' => 'Adresse IP',
        'throttle_attempts' => 'Tentatives',
        'throttle_last_attempt' => 'Dernière tentative',
        'throttle_suspended_at' => 'Suspendu le',
        'group' => [
            'name' => 'Groupe',
    ...
    'list' => [
        ...
        'sort_drag_title' => 'Glisser pour réorganiser',
    ...
    'form' => [
        ...
        'record_navigation' => 'Navigation dans les enregistrements',
    ...
    'relation' => [
        'missing_behavior' => 'Le champ ":field" nécessite que le contrôleur ":controller" implémente le comportement "RelationController".',
    ...
    'reorder' => [
        ...
        'reorder_title' => 'Réorganiser :name',
    ...
    'warnings' => [
        ...
        'auth_throttle_disabled' => 'Le throttling de l\'authentification du backend est désactivé. Cela n\'est pas recommandé pour les installations en production car cela peut permettre à des utilisateurs malveillants de forcer les mots de passe des utilisateurs.',
        'csrf' => 'La protection CSRF est désactivée. Cela n\'est pas recommandé pour les installations en production car cela compromet la sécurité des installations et peut permettre des attaques de type cross-site scripting.',
        'restrict_base_dir' => 'La restriction du répertoire de base est désactivée. Cela n\'est pas recommandé pour les installations en production car cela peut permettre aux thèmes et aux fichiers de configuration d\'accéder à des fichiers en dehors de votre installation Winter CMS.',
    ],
    'editor' => [
        ...
        'enable_folding' => 'Activer le repli du code',
        'bracket_colors' => 'Activer la coloration des couples de parenthèses',
        'show_colors' => 'Activer le sélecteur de couleurs en ligne',
        ...
        'paragraph_formats_comment' => 'Les options qui apparaîtront dans la liste déroulante des styles de paragraphe.',
    ...
    'permissions' => [
        ...
        'allow_unsafe_markdown_comment' => 'Autoriser le Markdown non sécurisé permettra d\'utiliser des balises HTML, y compris JavaScript, dans le contenu Markdown. Cela peut représenter un risque de sécurité si accordé à un utilisateur non fiable.',
    ],
    'mediafinder' => [
        'label' => 'Galerie média',

...
class Lists extends WidgetBase
{
    ...
    /**
     * Process as a "selectable" value (i.e. from an options array - usually generated by
     * `dropdown`, `radio`, `checkboxlist`, or similar form field types)
     */
    protected function evalSelectableTypeValue($record, ListColumn $column, $value): string
    {
        $options = $column->config['options'] ?? null;
     ...
     */
    protected function isColumnRelated(ListColumn $column, bool $isMultiRelation = false): bool
    {

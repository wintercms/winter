...
return [
    ...
    'plugins' => [
        ...
        'refresh_success' => 'Rresetare cu succes pentru plugin-urile selectate.',
    ...
    'project' => [
        ...
        'id' => [
            'label' => 'ID Proiect',
            'help' => 'Cum să găsiti ID-ul Proiectului',
    ...
    'mail' => [
        ...
        'menu_label' => 'Configurare e-mail',
        'menu_description' => 'Gestionați configurarea e-mail-ului.',
        'general' => 'General',
        'method' => 'Metoda pentru e-mail',
        ...
        'sparkpost' => 'SparkPost',
        'sparkpost_secret' => 'Cheie secretă SparkPost',
    ...
    'mail_templates' => [
        ...
        'partial' => 'Parțial',
        'partials' => 'Parțiale',
        'menu_layouts_label' => 'Scheme de e-mail',
        'menu_partials_label' => 'Parțiale de e-mail',
        'layout' => 'Schemă',
        'layouts' => 'Scheme',
        'no_layout' => '- Fără schemă -',
        'name' => 'Nume',
    ...
    'mail_brand' => [
        ...
        'sample_template' => [
            ...
            'subcopy' => 'Aceasta este subcopia e-mailului',
            'mulțumesc' => 'Mulțumesc',
        ],
        'fields' => [
            ...
            'table_border_color' => 'Culoare chenaru tabel',
    ...
    'updates' => [
        ...
        'core_downloading' => 'Se descarcă fișierele aplicatiei',
        ...
        'found' => [
            'label' => 'Au fost gasite actualizări noi!',
    ...
    'request_log' => [
        'hint' => 'Acest jurnal afișează o listă de solicitări efectuate de browser care pot să necesite atenție. De exemplu, dacă un vizitator deschide o pagină în CMS care nu poate fi gasită, o înregistrare va fi creată cu un cod de status 404.',
        'menu_label' => 'Jurnal solicitări',
        'menu_description' => 'Vizualizare solicitări eșuate sau redirecționate, precum Pagini care nu au fost gasite (404).',

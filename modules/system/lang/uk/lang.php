...
return [
    ...
    'permissions' => [
        ...
        'manage_editor_comment' => 'Цей дозвіл дозволяє користувачеві налаштовувати глобальні параметри редактора коду, включаючи користувацький CSS-контент, який відображатиметься у серверній частині. Це може становити загрозу безпеці, якщо його надати ненадійному користувачеві.',

<div class="updates-app">
    <div class="flex flex-layout-column gap-4 max-w-[1325px] mx-auto font-sans">
        <div class="w-full">
            <div class="flex flex-wrap gap-8 bg-blue-100/20 border border-blue-200 rounded-3xl shadow-sm mx-8 mt-8 py-10 px-10">
                <div class="title-value w-full-storm-fix sm:w-1/3 lg:w-2/8 bg-white p-6 rounded-3xl border border-blue-200 shadow-sm transition-transform duration-300 hover:scale-102">

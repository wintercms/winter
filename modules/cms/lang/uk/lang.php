...
return [
    ...
    'permissions' => [
        ...
        'manage_content_comment' => 'Цей дозвіл слід надавати лише довіреним користувачам, оскільки він дозволяє прямий доступ до файлів вмісту теми.',
        'manage_assets' => 'Керування файлами',
        'manage_assets_comment' => 'Цей дозвіл слід надавати лише довіреним користувачам, оскільки він надає прямий доступ до файлів ресурсів теми, які об\'єднуються та надаються публічно.',

...
class SourceManifestTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->builds = [
            '1.0.0' => new FileManifest(base_path('tests/fixtures/manifest/1_0_0'), ['test', 'test2']),
            '1.0.1' => new FileManifest(base_path('tests/fixtures/manifest/1_0_1'), ['test', 'test2']),
            '1.0.2' => new FileManifest(base_path('tests/fixtures/manifest/1_0_2'), ['test', 'test2']),
            '1.1.0' => new FileManifest(base_path('tests/fixtures/manifest/1_1_0'), ['test', 'test2', 'test3']),
            '1.1.1' => new FileManifest(base_path('tests/fixtures/manifest/1_1_1'), ['test', 'test2', 'test3']),
            '1.0.3' => new FileManifest(base_path('tests/fixtures/manifest/1_0_3'), ['test', 'test2']),
        ];
    ...
    {
        return base_path('tests/fixtures/manifest/forks.json');
    }
}

...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | File Extension Defitions
    |--------------------------------------------------------------------------
    |
    | Specifies the rules for identifying various files by their extension.
    | These are used to f
    |
    | media   - generated by the media manager.
    | uploads - generated by attachment model relationships.
    ...
    */
    'fileDefinitions' => [
        'defaultExtensions' => array_merge(\October\Rain\Filesystem\Definitions::get('defaultExtensions', false), []),
        'assetExtensions' => array_merge(\October\Rain\Filesystem\Definitions::get('assetExtensions', false), []),
        'imageExtensions' => array_merge(\October\Rain\Filesystem\Definitions::get('imageExtensions', false), []),
        'videoExtensions' => array_merge(\October\Rain\Filesystem\Definitions::get('videoExtensions', false), []),
        'audioExtensions' => array_merge(\October\Rain\Filesystem\Definitions::get('audioExtensions', false), []),
    ],
